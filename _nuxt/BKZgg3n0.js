...
Please report this to https://github.com/markedjs/marked.`,h){const o="<p>An error occurred:</p><pre>"+J(g.message+"",!0)+"</pre>";return b?Promise.resolve(o):S?void S(null,o):o}if(b)return Promise.reject(g);if(!S)throw g;S(g)}}((e={...I.defaults,...p}).silent,e.async,l);if(t==null)return c(new Error("marked(): input parameter is undefined or null"));if(typeof t!="string")return c(new Error("marked(): input parameter is of type "+Object.prototype.toString.call(t)+", string expected"));if(function(h){h&&h.sanitize&&!h.silent&&console.warn("marked(): sanitize and sanitizer parameters are deprecated since version 0.7.0, should not be used and will be removed in the future. Read more here: https://marked.js.org/#/USING_ADVANCED.md#options")}(e),e.hooks&&(e.hooks.options=e),l){const h=e.highlight;let b;try{e.hooks&&(t=e.hooks.preprocess(t)),b=x(t,e)}catch(o){return c(o)}const S=function(o){let m;if(!o)try{e.walkTokens&&I.walkTokens(b,e.walkTokens),m=n(b,e),e.hooks&&(m=e.hooks.postprocess(m))}catch(z){o=z}return e.highlight=h,o?c(o):l(null,m)};if(!h||h.length<3||(delete e.highlight,!b.length))return S();let g=0;return I.walkTokens(b,function(o){o.type==="code"&&(g++,setTimeout(()=>{h(o.text,o.lang,function(m,z){if(m)return S(m);z!=null&&z!==o.text&&(o.text=z,o.escaped=!0),g--,g===0&&S()})},0))}),void(g===0&&S())}if(e.async)return Promise.resolve(e.hooks?e.hooks.preprocess(t):t).then(h=>x(h,e)).then(h=>e.walkTokens?Promise.all(I.walkTokens(h,e.walkTokens)).then(()=>h):h).then(h=>n(h,e)).then(h=>e.hooks?e.hooks.postprocess(h):h).catch(c);try{e.hooks&&(t=e.hooks.preprocess(t));const h=x(t,e);e.walkTokens&&I.walkTokens(h,e.walkTokens);let b=n(h,e);return e.hooks&&(b=e.hooks.postprocess(b)),b}catch(h){return c(h)}}}function I(x,n,t){return jt(st.lex,it.parse)(x,n,t)}I.options=I.setOptions=function(x){var n;return I.defaults={...I.defaults,...x},n=I.defaults,rt=n,I},I.getDefaults=re,I.defaults=rt,I.use=function(...x){const n=I.defaults.extensions||{renderers:{},childTokens:{}};x.forEach(t=>{const e={...t};if(e.async=I.defaults.async||e.async||!1,t.extensions&&(t.extensions.forEach(l=>{if(!l.name)throw new Error("extension name required");if(l.renderer){const p=n.renderers[l.name];n.renderers[l.name]=p?function(...c){let h=l.renderer.apply(this,c);return h===!1&&(h=p.apply(this,c)),h}:l.renderer}if(l.tokenizer){if(!l.level||l.level!=="block"&&l.level!=="inline")throw new Error("extension level must be 'block' or 'inline'");n[l.level]?n[l.level].unshift(l.tokenizer):n[l.level]=[l.tokenizer],l.start&&(l.level==="block"?n.startBlock?n.startBlock.push(l.start):n.startBlock=[l.start]:l.level==="inline"&&(n.startInline?n.startInline.push(l.start):n.startInline=[l.start]))}l.childTokens&&(n.childTokens[l.name]=l.childTokens)}),e.extensions=n),t.renderer){const l=I.defaults.renderer||new St;for(const p in t.renderer){const c=l[p];l[p]=(...h)=>{let b=t.renderer[p].apply(l,h);return b===!1&&(b=c.apply(l,h)),b}}e.renderer=l}if(t.tokenizer){const l=I.defaults.tokenizer||new _t;for(const p in t.tokenizer){const c=l[p];l[p]=(...h)=>{let b=t.tokenizer[p].apply(l,h);return b===!1&&(b=c.apply(l,h)),b}}e.tokenizer=l}if(t.hooks){const l=I.defaults.hooks||new kt;for(const p in t.hooks){const c=l[p];kt.passThroughHooks.has(p)?l[p]=h=>{if(I.defaults.async)return Promise.resolve(t.hooks[p].call(l,h)).then(S=>c.call(l,S));const b=t.hooks[p].call(l,h);return c.call(l,b)}:l[p]=(...h)=>{let b=t.hooks[p].apply(l,h);return b===!1&&(b=c.apply(l,h)),b}}e.hooks=l}if(t.walkTokens){const l=I.defaults.walkTokens;e.walkTokens=function(p){let c=[];return c.push(t.walkTokens.call(this,p)),l&&(c=c.concat(l.call(this,p))),c}}I.setOptions(e)})},I.walkTokens=function(x,n){let t=[];for(const e of x)switch(t=t.concat(n.call(I,e)),e.type){case"table":for(const l of e.header)t=t.concat(I.walkTokens(l.tokens,n));for(const l of e.rows)for(const p of l)t=t.concat(I.walkTokens(p.tokens,n));break;case"list":t=t.concat(I.walkTokens(e.items,n));break;default:I.defaults.extensions&&I.defaults.extensions.childTokens&&I.defaults.extensions.childTokens[e.type]?I.defaults.extensions.childTokens[e.type].forEach(function(l){t=t.concat(I.walkTokens(e[l],n))}):e.tokens&&(t=t.concat(I.walkTokens(e.tokens,n)))}return t},I.parseInline=jt(st.lexInline,it.parseInline),I.Parser=it,I.parser=it.parse,I.Renderer=St,I.TextRenderer=Bt,I.Lexer=st,I.lexer=st.lex,I.Tokenizer=_t,I.Slugger=Ht,I.Hooks=kt,I.parse=I,I.options,I.setOptions,I.use,I.walkTokens,I.parseInline,it.parse,st.lex;/*!
 ...
 */const ye=()=>{let x,n,t,e,l,p,c;function h(){n=document.createElement("div"),n.classList.add("searchbox"),n.style.position="absolute",n.style.top="10px",n.style.right="10px",n.style.zIndex=10,n.innerHTML=`<input type="search" class="searchinput" placeholder="Search..." style="vertical-align: top;"/>
  ...
  <div id="logo-color"><img src="/styles/${t}/logo-fc.svg"></div>
  <div id="logo-part-white"><img src="/styles/${t}/logo-fc-part-white.svg"></div>
  <div id="logo-white"><img src="/styles/${t}/logo-fc-white.svg"></div>
  <div id="yellow-flag"><img class="left-e" src="/styles/${t}/e-logo.svg"></img></div>
  <div id="purple-half-circle-logo"><img class="logo" src="/styles/${t}/logo-fc-part-white.svg"></img></div>
  <div id="blue-strip"><div id="footer"></div></div>
  <img id="right-e" src="/styles/${t}/letter-e.svg"></img>
  <img id="left-e" src="/styles/${t}/e-logo.svg"></img>
  <div id="purple-blob">
    <div class="blob1"></div>
    <div class="blob2"></div>
    <div class="box"></div>
  </div>
  <div id="globe"><img src="/styles/${t}/globe.png"></img></div>
  <div id="mail"><img src="/styles/${t}/mail.png"></img></div>
  <div id="phone"><img src="/styles/${t}/phone.png"></img></div>
  `,n.prepend(e)}const Se={class:"flex relative box-border h-full reveal bg-eScienceWhite z-10"},$e={class:"slides flex h-full w-full"},Te={"data-markdown":"","data-separator":"^\\r?\\n===\\r?\\n$","data-separator-vertical":"^\\r?\\n==\\r?\\n$","data-separator-notes":"^Note:"},ze={props:{slidescontent:{type:String,default:"Missing Document"}},methods:{stripFrontmatter(x){return x.replace(/^---$.*?^---$/ms,"")}}},Ae=Wt({...ze,__name:"Slides",setup(x){return Kt(()=>{console.log("Slides Mounted"),Rt(()=>import("./B3O8JSaZ.js"),[],import.meta.url).then(n=>{Rt(()=>import("./DN7Rh_EM.js"),[],import.meta.url).then(t=>{new n.default().initialize({controls:!0,progress:!0,center:!0,hash:!0,transition:"none",embedded:!0,showNotes:!0,plugins:[xe,t.default,we,ve,ye]})})})}),(n,t)=>(ft(),yt("div",Se,[vt("div",$e,[vt("section",Te,Xt(n.stripFrontmatter(x.slidescontent)),1)])]))}}),Ee={},Re={key:0,class:"overflow-hidden h-full border-8 rounded-xl border-eScienceWhite z-10"},Ie={key:1,class:"flex justify-center items-center"},Le={class:"flex m-4 my-10 w-2/3 bg-eScienceWhite justify-center py-8 px-12"};function Ce(x,n){const t=Ae,e=se,l=ie;return ft(),Gt(l,null,{default:te(({doc:p})=>[p.type==="slides"?(ft(),yt("div",Re,[It(t,{slidescontent:p.plainText},null,8,["slidescontent"])])):(ft(),yt("div",Ie,[vt("div",Le,[It(e,{value:p,class:"font-body prose-lg max-w-4xl"},null,8,["value"])])]))]),_:1})}const He=Yt(Ee,[["render",Ce]]);export{He as default};
