var Jt=Object.defineProperty;var Vt=(b,n,e)=>n in b?Jt(b,n,{enumerable:!0,configurable:!0,writable:!0,value:e}):b[n]=e;var wt=(b,n,e)=>(Vt(b,typeof n!="symbol"?n+"":n,e),e);import{g as Ot,M as Ft,N as Wt,o as ft,c as yt,a as _t,C as Kt,w as Xt,b as Rt,A as Yt}from"./CFtI1chA.js";import{g as Gt,c as te}from"./Cpj98o6Y.js";import ee from"./fio-yYFF.js";import ne from"./B750t4Lt.js";import se from"./CjoW2sar.js";import"./CVwwMOaI.js";import"./Bs2YYpc5.js";import"./B5qZ1EV8.js";function re(){return{async:!1,baseUrl:null,breaks:!1,extensions:null,gfm:!0,headerIds:!0,headerPrefix:"",highlight:null,hooks:null,langPrefix:"language-",mangle:!0,pedantic:!1,renderer:null,sanitize:!1,sanitizer:null,silent:!1,smartypants:!1,tokenizer:null,walkTokens:null,xhtml:!1}}let it={async:!1,baseUrl:null,breaks:!1,extensions:null,gfm:!0,headerIds:!0,headerPrefix:"",highlight:null,hooks:null,langPrefix:"language-",mangle:!0,pedantic:!1,renderer:null,sanitize:!1,sanitizer:null,silent:!1,smartypants:!1,tokenizer:null,walkTokens:null,xhtml:!1};const Dt=/[&<>"']/,ie=new RegExp(Dt.source,"g"),Zt=/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,ae=new RegExp(Zt.source,"g"),le={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},It=b=>le[b];function J(b,n){if(n){if(Dt.test(b))return b.replace(ie,It)}else if(Zt.test(b))return b.replace(ae,It);return b}const oe=/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/gi;function Ut(b){return b.replace(oe,(n,e)=>(e=e.toLowerCase())==="colon"?":":e.charAt(0)==="#"?e.charAt(1)==="x"?String.fromCharCode(parseInt(e.substring(2),16)):String.fromCharCode(+e.substring(1)):"")}const ce=/(^|[^\[])\^/g;function H(b,n){b=typeof b=="string"?b:b.source,n=n||"";const e={replace:(t,a)=>(a=(a=a.source||a).replace(ce,"$1"),b=b.replace(t,a),e),getRegex:()=>new RegExp(b,n)};return e}const pe=/[^\w:]/g,he=/^$|^[a-z][a-z0-9+.-]*:|^[?#]/i;function Lt(b,n,e){if(b){let t;try{t=decodeURIComponent(Ut(e)).replace(pe,"").toLowerCase()}catch{return null}if(t.indexOf("javascript:")===0||t.indexOf("vbscript:")===0||t.indexOf("data:")===0)return null}n&&!he.test(e)&&(e=function(t,a){dt[" "+t]||(ue.test(t)?dt[" "+t]=t+"/":dt[" "+t]=mt(t,"/",!0)),t=dt[" "+t];const p=t.indexOf(":")===-1;return a.substring(0,2)==="//"?p?a:t.replace(de,"$1")+a:a.charAt(0)==="/"?p?a:t.replace(ge,"$1")+a:t+a}(n,e));try{e=encodeURI(e).replace(/%25/g,"%")}catch{return null}return e}const dt={},ue=/^[^:]+:\/*[^/]*$/,de=/^([^:]+:)[\s\S]*$/,ge=/^([^:]+:\/*[^/]*)[\s\S]*$/,xt={exec:function(){}};function Ct(b,n){const e=b.replace(/\|/g,(a,p,c)=>{let h=!1,x=p;for(;--x>=0&&c[x]==="\\";)h=!h;return h?"|":" |"}).split(/ \|/);let t=0;if(e[0].trim()||e.shift(),e.length>0&&!e[e.length-1].trim()&&e.pop(),e.length>n)e.splice(n);else for(;e.length<n;)e.push("");for(;t<e.length;t++)e[t]=e[t].trim().replace(/\\\|/g,"|");return e}function mt(b,n,e){const t=b.length;if(t===0)return"";let a=0;for(;a<t;){const p=b.charAt(t-a-1);if(p!==n||e){if(p===n||!e)break;a++}else a++}return b.slice(0,t-a)}function Mt(b,n){if(n<1)return"";let e="";for(;n>1;)1&n&&(e+=b),n>>=1,b+=b;return e+b}function Nt(b,n,e,t){const a=n.href,p=n.title?J(n.title):null,c=b[1].replace(/\\([\[\]])/g,"$1");if(b[0].charAt(0)!=="!"){t.state.inLink=!0;const h={type:"link",raw:e,href:a,title:p,text:c,tokens:t.inlineTokens(c)};return t.state.inLink=!1,h}return{type:"image",raw:e,href:a,title:p,text:J(c)}}class St{constructor(n){this.options=n||it}space(n){const e=this.rules.block.newline.exec(n);if(e&&e[0].length>0)return{type:"space",raw:e[0]}}code(n){const e=this.rules.block.code.exec(n);if(e){const t=e[0].replace(/^ {1,4}/gm,"");return{type:"code",raw:e[0],codeBlockStyle:"indented",text:this.options.pedantic?t:mt(t,`
 ...
 */const Pt="__SCRIPT_END__",gt=/\[\s*((\d*):)?\s*([\s\d,|-]*)\]/,me={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},ke=()=>{let b;function n(g){let o=(g.querySelector("[data-template]")||g.querySelector("script")||g).textContent;o=o.replace(new RegExp(Pt,"g"),"<\/script>");const m=o.match(/^\n?(\s*)/)[1].length,z=o.match(/^\n?(\t*)/)[1].length;return z>0?o=o.replace(new RegExp("\\n?\\t{"+z+"}(.*)","g"),function(E,C){return`
